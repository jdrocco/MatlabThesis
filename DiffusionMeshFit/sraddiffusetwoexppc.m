function [conc,newsum]=sraddiffusetwoexppc(region,maturtimeadj,initconc,diffconst,degconst,prodconst,tf)
...
normcoeff=1/prodsum;
% There really should be a reflection here if you want to be accurate.
% Another cut-corner approximation here is that you have the distribution
% of a single fluorophore at exactly 15 minutes.  You don't have the
% distribution when there are two populations and one is decaying into the
% other.
