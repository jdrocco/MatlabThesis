...
function plotframe(T, len, label)
    ...
    line([origin(1),X(1)], [origin(2), X(2)], [origin(3), X(3)]);
    line([origin(1),Y(1)], [origin(2), Y(2)], [origin(3), Y(3)]);
    line([origin(1),Z(1)], [origin(2), Z(2)], [origin(3), Z(3)]);
    
    text(X(1), X(2), X(3), ['x' label]);
    text(Y(1), Y(2), Y(3), ['y' label]);
    text(Z(1), Z(2), Z(3), ['z' label]);
