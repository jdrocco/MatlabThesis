function [totalmaskPHIS,totalregproPHIS]=findnucs(origim,sesize,intcutlow,intcuthigh,areamax,steppers)
...
PHIStop456=uint16(-(double(imtophat(origim,se5))-double(origim))-(double(imtophat(origim,se4))-double(origim))-(double(imtophat(origim,se6))-double(origim)));
